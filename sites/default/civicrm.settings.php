...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:sidekick@localhost/compucorp?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:sidekick@localhost:3306/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/var/www/html/compucorp/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/compucorp/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '9f2036ac7b62d9af94bbbde580d6df09');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/compucorp/sites/default/files/civicrm/templates_c//mail.log');
// }
